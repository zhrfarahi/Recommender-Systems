...
%chek shode
function [MOVIESID,tree,Bank,root,AVAIL_tree,AVAIL_Bank]=Insert_Bloomfilter(MOVIESID,ID,tree,Bank,parent_node,root,bf,AVAIL_tree,AVAIL_Bank)
...
if j==-1 
    gh=0;
    [MOVIESID,tree,root,Bank,AVAIL_tree,AVAIL_Bank]=Divide_Children(MOVIESID,ID,tree,Bank,root,bf,gh,parent_node,AVAIL_tree,AVAIL_Bank);
%--------------------------------------------------------------------
