...
function [MOVIESID,Bloofi_Tree,Bank,AVAIL_tree,AVAIL_Bank,Root]=Bloomfi_Tree_Build
...
for i=3:s(1)
    ...
    [MOVIESID,Bloofi_Tree,Bank,Root,AVAIL_tree,AVAIL_Bank]=Insert_Bloomfilter(MOVIESID,i,Bloofi_Tree,Bank,node,Root,DS_bloomfilter(i,1:s(2)),AVAIL_tree,AVAIL_Bank);
    fprintf("Counter =%d\n",i);
end %end of for
